...
export default function MyCoursesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 my-courses-container" style={{ position: 'static', transform: 'none' }}>
      <style jsx>{`
        ...
        .my-courses-container .my-courses-grid {
        ...
        .my-courses-container .my-courses-card {
          position: static !important;
          transform: none !important;
          width: 100% !important;
          animation: none !important;
        ...
        /* 모든 슬라이더 관련 스타일 무력화 */
        .my-courses-container [class*="slide"],
        .my-courses-container [class*="slider"],
        .my-courses-container [class*="carousel"] {
          position: static !important;
          transform: none !important;
          animation: none !important;
        }
