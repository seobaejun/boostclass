...
class TailwindMCPServer {
            ...
            try {
                switch (name) {
                    case 'search_tailwind_classes':
                        return await this.searchTailwindClasses(args);
                    case 'get_component_example':
                        return await this.getComponentExample(args);
                    case 'explain_tailwind_class':
                        return await this.explainTailwindClass(args);
                    case 'generate_tailwind_component':
                        return await this.generateTailwindComponent(args);
                    case 'get_responsive_classes':
                        return await this.getResponsiveClasses(args);
                    case 'get_color_palette':
                        return await this.getColorPalette(args);
                    default:
    ...
    async searchTailwindClasses(args) {
        ...
        else if (TAILWIND_CLASSES[category]) {
            const categoryData = TAILWIND_CLASSES[category];
    ...
    async getComponentExample(args) {
        const { component } = args;
        if (COMPONENT_EXAMPLES[component]) {
            const example = COMPONENT_EXAMPLES[component];
            return {
                content: [
                    {
                        type: 'text',
    ...
    async explainTailwindClass(args) {
    ...
    async generateTailwindComponent(args) {
  ...
  <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
    ...
    generateGeneric(description, type) {
  ...
  <p class="text-gray-600">
    ...
    async getResponsiveClasses(args) {
